<template>
  <aside class="sm-side">
    <div class="user-head">
      ...
      <div class="user-name">
          <h5>Cuong TanPhu</h5>
          <span class="email-address">lqcuong.qt@gmail.com</span>
      </div>
    </div>
    ...
    <ul class="inbox-nav">
      ...
      <li :class="{ active: activeView == 'app-list-products' }">
        <a href="#" @click.prevent="navigate('app-list-products', 'List Products')">
          <i class=" fa fa-trash-o"></i>ListProducts <span class="label label-default pull-right">{{ totalProducts.length }}</span>
        </a>
      </li>
    </ul>
  </aside>
...
<script>
  ...
  import ListProducts from '../mixins/retrieve-products'
